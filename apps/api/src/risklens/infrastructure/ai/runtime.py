...
RUNTIME_FIELDS: dict[str, tuple[str, Any]] = {
    ...
    "top_p": ("llm_top_p", settings.llm_top_p),
    "sampling_top_k": ("llm_sampling_top_k", settings.llm_sampling_top_k),
    "min_p": ("llm_min_p", settings.llm_min_p),
    "frequency_penalty": ("llm_frequency_penalty", settings.llm_frequency_penalty),
    "presence_penalty": ("llm_presence_penalty", settings.llm_presence_penalty),
    "seed": ("llm_seed", settings.llm_seed),
    "chunk_size": ("rag_chunk_size", settings.rag_chunk_size),
    "top_k": ("rag_top_k", settings.rag_top_k),
    "agent_max_chars_per_chunk": ("agent_max_chars_per_chunk", settings.agent_max_chars_per_chunk),
    "agent_max_evidence_chars": ("agent_max_evidence_chars", settings.agent_max_evidence_chars),
